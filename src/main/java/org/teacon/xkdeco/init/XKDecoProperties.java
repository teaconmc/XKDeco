...
public final class XKDecoProperties {
	...
	public static final BlockBehaviour.Properties BLOCK_SANDSTONE = BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(
			1.5f,
			6f);
	public static final BlockBehaviour.Properties BLOCK_GLASS = BlockBehaviour.Properties.of()
			...
			.strength(1.5f, 3f);
	public static final BlockBehaviour.Properties BLOCK_IRON = BlockBehaviour.Properties.of()
			.mapColor(MapColor.METAL)
			.strength(2f, 12f)
			.requiresCorrectToolForDrops();
	public static final BlockBehaviour.Properties BLOCK_HARD_IRON = BlockBehaviour.Properties.of().mapColor(MapColor.METAL).strength(
			3f,
			12f).requiresCorrectToolForDrops();
	public static final BlockBehaviour.Properties BLOCK_HOLLOW_IRON = BlockBehaviour.Properties.of().mapColor(MapColor.METAL).strength(
			3f,
			12f).noOcclusion().requiresCorrectToolForDrops();
	public static final BlockBehaviour.Properties BLOCK_GOLD = BlockBehaviour.Properties.of()
			.mapColor(MapColor.GOLD)
			.strength(3f, 12f)
			.requiresCorrectToolForDrops();
	public static final BlockBehaviour.Properties BLOCK_COPPER = BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_ORANGE).strength(
			2f,
			12f).requiresCorrectToolForDrops();
	public static final BlockBehaviour.Properties BLOCK_BRONZE = BlockBehaviour.Properties.of()
			.mapColor(MapColor.WARPED_NYLIUM)
			.strength(3f, 12f)
			.requiresCorrectToolForDrops();
	public static final BlockBehaviour.Properties BLOCK_WOOD = BlockBehaviour.Properties.of()
			.mapColor(MapColor.WOOD)
			.ignitedByLava()
			.strength(2f, 3f)
			.requiresCorrectToolForDrops();
	public static final BlockBehaviour.Properties BLOCK_BRICK = BlockBehaviour.Properties.of()
			.mapColor(MapColor.STONE)
			.strength(1.8f, 6f)
			.requiresCorrectToolForDrops();
	public static final BlockBehaviour.Properties BLOCK_STONE = BlockBehaviour.Properties.of()
			.mapColor(MapColor.STONE)
			.strength(1.8f, 9f)
			.requiresCorrectToolForDrops();
	public static final BlockBehaviour.Properties BLOCK_HARD_STONE = BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(
			2f,
			10f).requiresCorrectToolForDrops();
	public static final BlockBehaviour.Properties BLOCK_OBSIDIAN = BlockBehaviour.Properties.of().pushReaction(PushReaction.BLOCK).mapColor(
			MapColor.COLOR_BLACK).strength(20f, 20f).requiresCorrectToolForDrops();
	public static final BlockBehaviour.Properties BLOCK_LIGHT = BlockBehaviour.Properties.of()
			.mapColor(MapColor.NONE)
			.noOcclusion()
			.strength(2f, 10f)
			.lightLevel(s -> 15);
	...
	public static final BlockBehaviour.Properties BLOCK_HARD_SAND = BlockBehaviour.Properties.of().mapColor(MapColor.SAND).strength(
			1f,
			12f);
	...
	public static final BlockBehaviour.Properties BLOCK_NETHER_STONE = BlockBehaviour.Properties.of()
			.mapColor(MapColor.STONE)
			.strength(0.5f, 1f)
			.requiresCorrectToolForDrops();
	public static final BlockBehaviour.Properties BLOCK_END_STONE = BlockBehaviour.Properties.of()
			.mapColor(MapColor.STONE)
			.strength(2f, 9f)
			.requiresCorrectToolForDrops();
	public static final BlockBehaviour.Properties BLOCK_LEAVES = BlockBehaviour.Properties.of().mapColor(MapColor.PLANT).pushReaction(
			PushReaction.DESTROY).ignitedByLava().strength(1f, 0.2f).noOcclusion();
	...
	public static final BlockBehaviour.Properties BLOCK_BOARD = BlockBehaviour.Properties.of()
			...
			.strength(0.5f, 0.5f)
			.noOcclusion();
	public static final BlockBehaviour.Properties BLOCK_ROOF = BlockBehaviour.Properties.of()
			.mapColor(MapColor.STONE)
			.strength(1.8f, 12f)
			.noOcclusion();
