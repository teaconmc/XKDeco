...
public class XKDRecipeProvider extends FabricRecipeProvider {
	...
	public void buildRecipes(Consumer<FinishedRecipe> consumer) {
		...
		shapelessTwoToOne(consumer, BUILDING_BLOCKS, i("grass_cobblestone"), Items.GRASS, Items.COBBLESTONE, 1, false);
	...
	private void stoneLamp(Consumer<FinishedRecipe> consumer, ItemLike lamp, ItemLike material) {
	...
	private static void miniature(Consumer<FinishedRecipe> consumer, String result, ItemLike material) {
