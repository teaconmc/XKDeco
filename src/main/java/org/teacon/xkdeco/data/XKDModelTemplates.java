...
public class XKDModelTemplates {
	...
	private static void bootstrap() {
		...
		createShift("hollow_steel_beam_oblique", TextureSlot.BOTTOM);
		createShift("hollow_steel_beam_oblique_slow", TextureSlot.BOTTOM);
		createShift("hollow_steel_beam_oblique_steep", TextureSlot.BOTTOM);
